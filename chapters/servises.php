...
<div class="filter_bg">
    <section class="one">
        ...
        <div class="header">
            <div class="container">
                <div class="row">
                    <h1 class="header__title wow fadeIn" data-wow-delay="0.4s">Простые и недорогие аудио ролики</h1>
                    <h2 class="header__description wow fadeIn" data-wow-delay="0.6s">Послушать примеры наших работ можно здесь</h2>
                    <div class="header__button-block">
                        <div class="header__button_about to_examples wow fadeIn" data-wow-delay="0.8s">примеры роликов</div>
                        <div class="header__button-price to_scripts wow fadeIn" data-wow-delay="1s">примеры сценариев</div>
                    </div>
                </div>
            </div>
        </div>
